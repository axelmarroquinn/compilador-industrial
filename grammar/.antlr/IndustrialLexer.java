...
public class IndustrialLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"MAQUINA", "SENSOR", "PROCESO", "ALARMA", "INICIAR", "DETENER", "PAUSAR", 
			"REINICIAR", "SI", "ENTONCES", "SINO", "FIN", "MIENTRAS", "HACER", "REPETIR", 
			"VECES", "LEER", "ESCRIBIR", "ESPERAR", "MS", "VAR", "NUM", "TEXTO", 
			"BOOL", "VERDADERO", "FALSO", "Y", "O", "NO", "MAYOR_IGUAL", "MENOR_IGUAL", 
			"IGUAL_IGUAL", "DIFERENTE", "MAYOR", "MENOR", "IGUAL", "MAS", "MENOS", 
			"MULT", "DIV", "LLAVE_AB", "LLAVE_CE", "PAREN_AB", "PAREN_CE", "PUNTO_COMA", 
	...
	public IndustrialLexer(CharStream input) {
		super(input);
